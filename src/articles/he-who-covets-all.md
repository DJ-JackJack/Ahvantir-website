...
## Source Notes
> **Source**
> Source: `DM ruling` — confirmed canon 2026-03-28. Absent from `The_Primordem_of_Ahvantir.pdf` for documented reasons (different sealing circumstances). Nature, form, philosophy, Record XXVII, and the Disturbing Possibility section: `DM canon` — ChatGPT lore session, confirmed 2026-05-12.
